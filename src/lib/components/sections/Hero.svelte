...
>
    ...
    >
      ...
      >
        ...
        <div class="flex flex-col gap-2 text-center md:text-left">
          ...
          >
            A computer science student at UCF seeking software engineering
      ...
      >
        ...
        >
          <a
            ...
            class="p-2 rounded-none border-2 border-foreground/30 text-foreground/70 hover:text-foreground hover:border-foreground/50 shadow-[2px_2px_0px_0px] shadow-foreground/10 hover:shadow-[1px_1px_0px_0px] hover:translate-x-[1px] hover:translate-y-[1px] transition-all"
            aria-label="GitHub"
          >
  ...
  <a href="#projects" class="absolute bottom-8 left-1/2 -translate-x-1/2">
    {#if visible}
      <div in:fade={{ duration: 600, delay: 700 }} class="animate-bounce">
        <ArrowDown class="h-8 w-8 text-muted-foreground" />
      </div>
    {/if}
  </a>
</section>
