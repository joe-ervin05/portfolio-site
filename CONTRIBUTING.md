...
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/joe-ervin05/portfolio-site.git
   ```
...
If you have any questions about contributing, feel free to create an issue or reach out.
